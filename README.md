...
Movies Review App is a simple Android application built as a college project.
...
Splash | Home | Movie Details | Add Review

(Replace the below placeholders with real images)
...
Uses local storage — no internet required
